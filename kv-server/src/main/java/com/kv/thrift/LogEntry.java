...
public class LogEntry implements org.apache.thrift.TBase<LogEntry, LogEntry._Fields>, java.io.Serializable, Cloneable, Comparable<LogEntry> {
    ...
    public @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer command; // required
            ...
            java.nio.ByteBuffer command)
    {
        ...
        this.term = term;
        setTermIsSet(true);
        this.command = org.apache.thrift.TBaseHelper.copyBinary(command);
    }
    ...
    public LogEntry(LogEntry other) {
        ...
        if (other.isSetCommand()) {
            this.command = org.apache.thrift.TBaseHelper.copyBinary(other.command);
        }
    }
    ...
    public byte[] getCommand() {
        setCommand(org.apache.thrift.TBaseHelper.rightSize(command));
        return command == null ? null : command.array();
    }

    public java.nio.ByteBuffer bufferForCommand() {
        return org.apache.thrift.TBaseHelper.copyBinary(command);
    }

    public LogEntry setCommand(byte[] command) {
        this.command = command == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(command.clone());
        return this;
    }

    public LogEntry setCommand(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer command) {
        this.command = org.apache.thrift.TBaseHelper.copyBinary(command);
        return this;
    }
            ...
            case COMMAND:
                if (value == null) {
                    ...
                    if (value instanceof byte[]) {
                        setCommand((byte[])value);
                    } else {
                        setCommand((java.nio.ByteBuffer)value);
                    }
                }
                break;
    ...
    public java.lang.String toString() {
        ...
        if (this.command == null) {
            ...
            org.apache.thrift.TBaseHelper.toString(this.command, sb);
        }
        first = false;
        sb.append(")");
        return sb.toString();
    ...
    private static class LogEntryStandardScheme extends org.apache.thrift.scheme.StandardScheme<LogEntry> {
                ...
                switch (schemeField.id) {
                    ...
                    case 3: // COMMAND
                        if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
                            struct.command = iprot.readBinary();
        ...
        public void write(org.apache.thrift.protocol.TProtocol oprot, LogEntry struct) throws org.apache.thrift.TException {
            ...
            if (struct.command != null) {
                ...
                oprot.writeBinary(struct.command);
                oprot.writeFieldEnd();
            }
