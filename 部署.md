...
mkdir -p /Users/jerry/conf/{node1,node2,node3}
mkdir -p /Users/jerry/data/{node1,node2,node3}/{rocksdb,raft-log}
mkdir -p /Users/jerry/logs/{node1,node2,node3}
```
...
1. 启动节点1:
```bash
/Users/jerry/bin/start-server.sh node1 /Users/jerry/IdeaProjects/LightKV/kv-store/conf/node1
```

2. 启动节点2:
```bash
/Users/jerry/bin/start-server.sh node2 /Users/jerry/IdeaProjects/LightKV/kv-store/conf/node2
```

3. 启动节点3:
```bash
/Users/jerry/bin/start-server.sh node3 /Users/jerry/IdeaProjects/LightKV/kv-store/conf/node3
```

4. 启动客户端:
```bash
/Users/jerry/bin/start-client.sh localhost 8090
```